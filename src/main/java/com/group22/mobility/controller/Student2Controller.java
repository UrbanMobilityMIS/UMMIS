...
public class Student2Controller {
        ...
        public String returnVehicle(
                ...
                String message = student2Service.returnVehicle(id);
        ...
        public String returnVehicleMongo(
                ...
                String message = student2Service.returnVehicleMongo(id);
        ...
        public String mongoRent(
                ...
                String message = student2Service.rentVehicleMongo(userId, vehicleId);
        ...
        public String mongoAnalytics(
                ...
                // Most active user
                Map<String, Long> userCounts = mongoRentals.stream()
                                .collect(Collectors.groupingBy(
                                                r -> r.getUserEmail(),
                                                Collectors.counting()));

                long maxUserCount = userCounts.values()
                                .stream()
                                .max(Long::compare)
                                .orElse(0L);

                String mostActiveUser = userCounts.entrySet()
                                .stream()
                ...
                // Most rented vehicle
                Map<String, Long> vehicleCounts = mongoRentals.stream()
                                .collect(Collectors.groupingBy(
                                                r -> r.getVehicleModel(),
                                                Collectors.counting()));

                long maxVehicleCount = vehicleCounts.values()
                                .stream()
                                .max(Long::compare)
                                .orElse(0L);

                String mostRentedVehicle = vehicleCounts.entrySet()
                                .stream()
