...
public class Student3Controller {
    ...
    @PostMapping("/student3/mongo/usecase")
    public String submitMongoUseCase(MongoTechnicianUseCaseDto dto,
                                     RedirectAttributes redirectAttributes) {

        TechnicianMaintenanceDocument document =
                student3MongoService.createMongoTechnicianMaintenance(dto);
    ...
    @GetMapping("/student3/mongo/migration")
