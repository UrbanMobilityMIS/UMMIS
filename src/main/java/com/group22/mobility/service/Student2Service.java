...
import com.group22.mobility.repository.mongodb.UserMongoRepository;
import com.group22.mobility.repository.mongodb.VehicleMongoRepository;
import com.group22.mobility.model.mongodb.RentalDocument;
import com.group22.mobility.repository.mongodb.RentalMongoRepository;
...
public class Student2Service {
                ...
                if (fromDate != null && toDate != null) {
                        ...
                        return rentals.stream()
                                        .filter(rental -> {
                                                ...
                                                LocalDate rentalDate = rental.getStartTime().toLocalDate();
        ...
        public String getFilteredMostActiveUser(
                ...
                Map<String, Long> rentalsPerUser = rentalRepository.findByEndTimeIsNull()
                                .stream()
        ...
        public String getFilteredMostRentedVehicle(
                ...
                Map<String, Long> rentalsPerVehicle = rentalRepository.findByEndTimeIsNull()
                                .stream()
                                .collect(Collectors.groupingBy(
        ...
        public String rentVehicleMongo(Integer userId, Integer vehicleId) {
                ...
                UserDocument user = userMongoRepository.findByUserId(userId)
                                .orElseThrow();

                VehicleDocument vehicle = vehicleMongoRepository.findByVehicleId(vehicleId)
                                .orElseThrow();
        ...
        public String returnVehicleMongo(Integer rentalId) {
                ...
                RentalDocument rental = rentalMongoRepository.findByRentalId(rentalId)
                                .orElseThrow();
                ...
                VehicleDocument vehicle = vehicleMongoRepository.findByVehicleId(
                                rental.getVehicleId()).orElseThrow();
