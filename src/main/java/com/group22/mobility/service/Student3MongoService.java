...
import com.group22.mobility.repository.mongodb.TechnicianMaintenanceDocumentRepository;
...
public class Student3MongoService {
        ...
        public List<Level2TechnicianMongoReportRow> getLevel2TechnicianReport() {
                ...
                List<TechnicianMaintenanceDocument> documents = mongoRepository
                                .findByCertificationLevelOrderByRepairDateDesc("Level 2");
